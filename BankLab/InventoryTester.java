public class InventoryTester {
    public static void main(String[] args) {
        ...
        // Testing Getters
        System.out.println("1. Item 1 Name: " + item1.getItemName() + testGetItemName(item1, "Laptop"));
        System.out.println("2. Item 2 Quantity: " + item2.getQuantity() + testGetQuantity(item2, 5));
