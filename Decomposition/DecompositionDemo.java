public class DecompositionDemo {
    ...
    public DecompositionDemo() { // constructor / Daily Steps Analysis (12 hours): parallel arrays, arrays only
        ...
        int n = hours.length; // if the arrays are not the same length, the function exits.
    ...
    public static double avgSteps(int[] steps, int[] hours, int n) {
        int totalSteps = 0;
    ...
    public static double findAverageOfMinutes(int[] activeMinutes, int n) {
        ...
        return avgActiveMinutes;
    }

    public static void calculateAverages(int n, int[] steps) {
