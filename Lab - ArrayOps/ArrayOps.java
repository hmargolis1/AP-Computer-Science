public class ArrayOps {
    ...
    public static String printStringArray(String[] array) {
        ...
        if (array != null) {
            ...
            for(int x = 0; x < array.length - 1; x++) {
                ...
                returningArray += array[x];
            }

            System.out.println("[" + printingArray + lastArrayValue + "]");
            return returningArray + lastArrayValue;
        }
        return "[]";
    }
    ...
    public static String findLongestString(String[] array) {
        if(array != null) {
            String largestString = array[array.length -1];
            for(int x = 0; x < array.length -1; x++) {
                if(largestString.length() < array[x].length()) {
                    largestString.equals(array[x]);
                }
            }
